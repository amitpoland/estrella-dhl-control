...
| **commercial** | PROFORMA + IMPORT_PZ + SALES (separate authorities, Lesson R) | Proforma / Sales / PZ pages | proforma DB, `documents.db`, sales linkage | `capabilities/commercial/manifest.md` |
...
- **No cross-authority guard without a named business rule + a pinning test** (Lesson R —
