...
| CMR party-authority cycle | **PREMISE DISPROVEN — held before edit** | `fix/cmr-party-authority-cycle` | — | branch cut from `994a2a4d`, **no runtime file edited**. There is no cycle to repair: see F-36 | 2026-08-22 |
