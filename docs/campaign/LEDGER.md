...
| F-22 | MED | The final document of batch `…6696117050` is MISSING 3 real lines (L1 swallowed them at ingestion: 24 in the file, 21 stored). Re-ingestion after the L1 fix lands restores them — a data repair, not a code change | P0 experiment vs stored rows | S0 deploy + re-ingest |
