...
| `intelligence` | `GET /api/v1/intelligence/status`, `GET /api/v1/intelligence/suggestions`, `GET /api/v1/intelligence/config`, `GET /api/v1/invoice-learning/summary` | Sprint 34 |
