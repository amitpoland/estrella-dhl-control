...
def build_pz_request_from_proforma_snapshot(snap: ProformaSnapshot, warehouse_id: str):
    """
    ...
    Returns a wfirma_client.PZRequest ready for create_warehouse_pz().
    ...
    for line in snap.contents:
        ...
        try:
            ...
            raise ValueError(f"non-numeric unit_count/price for good_id={gid!r}: {exc}") from exc
