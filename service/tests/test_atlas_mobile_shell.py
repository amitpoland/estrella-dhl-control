...
Guards the regression shown in production screenshots: fixed 220px sidebar
staying mounted on narrow viewports and crushing the Dashboard content.
"""
...
def test_v2_index_uses_js_narrow_breakpoint():
    ...
    assert "onOpenMenu={isNarrow" in html
...
def test_v2_index_mobile_drawer_left_side():
    ...
    # Drawer panel precedes backdrop so nav slides from the left
