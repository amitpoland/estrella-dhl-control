...
// D-1 guards (APP-1 URL param, APP-2 envelope unwrap) are preserved from PR #788.
...
// ── URL param parsing (APP-1 fix: accepts ?draft= as fallback to ?draft_id=) ──
...
export default function App() {
  ...
  // Apply theme to <html> so CSS vars cascade correctly across the full page
  useEffect(() => {
  ...
  useEffect(() => {
    if (params.draftId) {
      ...
      // APP-2 fix: unwrap {"ok":true,"draft":{…}} envelope — setDraft(data.draft)
